...
# Фэнтези
db.add_book("Властелин колец", "Дж. Р. Р. Толкин", 1954, "Эпическая история о кольце всевластья", 500, 5, ".\\images\\hsdlcjlcjkjklsax.jpg")
db.add_book("Игра престолов", "Джордж Мартин", 1996, "Борьба за Железный трон Вестероса", 490, 5, ".\\images\\22669.970x0.jpg")
db.add_book("Гарри Поттер и философский камень", "Дж. К. Роулинг", 1997, "Первый роман о юном волшебнике", 350, 5, ".\\images\\afchojsdcnocuibs.jpg")

# Наука
db.add_book("Краткая история времени", "Стивен Хокинг", 1988, "О черных дырах и происхождении вселенной", 400, 6, ".\\images\\10903489_0.jpg")
db.add_book("Самые красивые теории", "Жан-Пьер Лумине", 2011, "Об истории научных открытий", 380, 6, ".\\images\\oandadlkaa.jpg")
db.add_book("Гены, народы и языки", "Лука Кавалли-Сфорца", 2000, "О генетическом происхождении человечества", 410, 6, ".\\images\\mclkscms.jpg")

# Путешествия
db.add_book("Вокруг света за 80 дней", "Жюль Верн", 1873, "Путешествие Филиаса Фогга", 340, 7, ".\\images\\12200444.jpg")
db.add_book("Путешествие к центру Земли", "Жюль Верн", 1864, "Опускаясь в глубины земной коры", 330, 7, ".\\images\\101111030_0.jpg")
db.add_book("Дорогами Сибири", "Сильвен Тессон", 2010, "Путешествие по заснеженной Сибири", 350, 7, ".\\images\\dans les forets de siberie.jpg")

# Биография
db.add_book("Стив Джобс", "Уолтер Айзексон", 2011, "Биография основателя Apple", 460, 8, ".\\images\\10212062_0.jpg")
db.add_book("Диарея молодой девушки", "Анна Франк", 1947, "Жизнь в скрытности во время Второй мировой войны", 290, 8, ".\\images\\768.jpg")
db.add_book("Леонардо да Винчи", "Уолтер Айзексон", 2017, "Исследование жизни великого гения", 480, 8, ".\\images\\101165301_0.jpg")

# Поэзия
db.add_book("Сонеты", "Уильям Шекспир", 1609, "Коллекция из 154 сонетов", 250, 9, ".\\images\\cover1__w600 (1).jpg")
db.add_book("Лирика", "Анна Ахматова", 1917, "Стихи великой русской поэтессы", 240, 9, ".\\images\\cover1__w600 (2).jpg")
db.add_book("Стихи", "Роберт Фрост", 1916, "Избранные стихи американского поэта", 230, 9, ".\\images\\41CZcjZYsKL._AC_UF1000,1000_QL80_.jpg")


# Философия
db.add_book("Бытие и время", "Мартин Хайдеггер", 1927, "Философский трактат", 600, 10, ".\\images\\10170196_0.jpg")
db.add_book("Мир как воля и представление", "Артур Шопенгауэр", 1819, "Основные идеи философии Шопенгауэра", 700, 10, ".\\images\\h1001_w1001_8ba1baf3e21088453a7f783fa0ee8328.jpg")
db.add_book("Критика чистого разума", "Иммануил Кант", 1781, "Основополагающий труд Канта", 650, 10, ".\\images\\ocnjaalcnajcna.jpg")
